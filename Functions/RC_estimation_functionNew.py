...
import numpy as np
import pandas as pd
import RC_GeneratorRiverNew
from objectGenerationRiver_func import*

def RC_estimation_function(processList,CombList,Clist,MP_prop,compartments_prop,process_df,numberRS, composition,mode2, mode, date,riverComp,MPforms,sizeBin,river_flows):

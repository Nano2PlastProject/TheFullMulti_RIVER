...
"""
import numpy as np
def reshape_RC_df2(RC_df,CombList):
    ### Reshape table of RC
    ...
    RC_df_final.loc[(RC_df_final.SizeFrac == "a"),'SizeFrac']='0.1 \u03BCm'
    RC_df_final.loc[(RC_df_final.SizeFrac == "b"),'SizeFrac']='1 \u03BCm'
    RC_df_final.loc[(RC_df_final.SizeFrac == "c"),'SizeFrac']='10 \u03BCm'
    RC_df_final.loc[(RC_df_final.SizeFrac == "d"),'SizeFrac']='100 \u03BCm'
    RC_df_final.loc[(RC_df_final.SizeFrac == "e"),'SizeFrac']='1000 \u03BCm'
